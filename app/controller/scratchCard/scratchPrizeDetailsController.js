...
module.exports = {
    ...
    add: async function (req, res) {
        ...
        if (validation.passes()) {
            ...
            let _is_win = req.body.is_win ? req.body.is_win : null;
            let _is_credited = req.body.is_credited ? req.body.is_credited : null;
            let _is_claim = req.body.is_claim ? req.body.is_claim : null;
            ...
            if (!_id) {
                ...
                _query = {
                    text: "INSERT INTO tbl_scratch_campaign_prizes_details(camp_id,banner_id,status,created_date) VALUES ($1,$2,$3,$4) RETURNING *",
                    values: [
                ...
                _query = {
                    text: "UPDATE tbl_scratch_campaign_prizes_details SET id=$1,camp_id=$2,banner_id=$3,status=$4,created_date=$5 RETURNING *",
                    values: [
